...
download_dir.mkdir(parents=True, exist_ok=True) # create scratch dir if it doesn't exist
...
for month in months:
    ...
    for pl_variable in pl_variables:
        args = (pl_variable, years, month, days, hours_utc, p_levels, pl_dataset, download_dir)
        args_list.append(args)

    for variable in sfc_variables:
        args = (variable, years, month, days, hours_utc, "sfc", sfc_dataset, download_dir)
        args_list.append(args)

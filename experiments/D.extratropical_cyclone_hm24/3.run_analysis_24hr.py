...
titles = [
    f"{model_name.upper()}: $Z_{{500}}$ Anomalies from {season} Climatology at t={t*24} hours"
...
titles = [
    f"{model_name.upper()}: $T_{{500}}$ Anomalies from {season} Climatology at t={t*24} hours"
    for t in range(0, n_timesteps + 1)
]

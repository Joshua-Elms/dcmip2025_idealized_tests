...
for model_name in models:
    ...
    fig, ax = plt.subplots(nrows=3,ncols=1,figsize=(11*1.5,8.5*2),subplot_kw={'projection': projection}, layout='constrained')
    ...
    for it in [0,1,2]:
        ...
        print(f"it={it} basefield min/max/mean :", np.nanmin(basefield), np.nanmax(basefield), np.nanmean(basefield))
